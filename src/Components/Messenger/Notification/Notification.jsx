...
const Notification = () => {
  ...
  return (
    <div
      ...
      className="p-8 h-screen rounded-lg max-w-md mx-auto overflow-y-scroll z-20"
    >
      {/* Header */}
      <div className="flex items-center justify-between mb-4 space-x-3">
        <h1 className="text-2xl font-bold text-[#191816]">Notifications</h1>
        <div onClick={()=>dispatch(setopen_notification())} className="duration-500 p-3 cursor-pointer items-center justify-center bg-white rounded-full shadow-md">
          <RiArrowRightDoubleLine
            className="cursor-pointer text-[#191816] hover:text-gray-700  duration-300"
            size={25}
          />
        </div>
      </div>
